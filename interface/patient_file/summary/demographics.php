...
//zys
     $fname_zys =  htmlspecialchars($result['fname'] . " " . $result['lname'],ENT_NOQUOTES) . "";

     echo "<input  id = \"btnSubmit\" type=\"submit\" value=\"Call\"/>";
...
<script>
    ...
    $(document).ready(function() {
        $("#btnSubmit").click(function(){
            // alert("button");
            socket.emit('chat message', '<?php echo $fname_zys ; ?>');
        });
    })
</script>
